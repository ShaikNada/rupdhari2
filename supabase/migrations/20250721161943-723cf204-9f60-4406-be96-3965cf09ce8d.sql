...
-- Add missing variation columns to products table for customization handling
ALTER TABLE public.products 
ADD COLUMN IF NOT EXISTS is_main_variant BOOLEAN DEFAULT true,
...
CREATE INDEX IF NOT EXISTS idx_products_parent_variant ON public.products(parent_product_id, is_main_variant);
CREATE INDEX IF NOT EXISTS idx_products_name_code ON public.products(name, product_number);